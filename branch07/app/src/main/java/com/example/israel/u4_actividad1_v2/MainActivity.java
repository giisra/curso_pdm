package com.example.israel.u4_actividad1_v2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //El UI thread se utiliza para modificar los componentes visuales de Android (animaciones,
        // cambiar valores de controles, transiciones de pantallas...), si tratamos de hacer esto
